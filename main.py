...
tf.app.flags.DEFINE_string('sketch_views', 'F',
...
tf.app.flags.DEFINE_string('data_dir', '/vol/research/zy/dataSets/shapeMVD/Chair/',
							"""Directory containing training/testing images.""")
tf.app.flags.DEFINE_string('sketch_dir', '/vol/research/ycres/zy/dataSets/occ/ShapeNet/',
							"""Directory containing training/testing images.""")
tf.app.flags.DEFINE_string('sketch_set', '/naive_mad',
							"""Directory containing training/testing images.""")
tf.app.flags.DEFINE_string('train_dir', '/vol/research/zyres/3dv/baselines/SketchModeling/Network/Checkpoint/',
							"""Directory where to write training logs.""")
tf.app.flags.DEFINE_string('test_dir', '/vol/research/zyres/3dv/baselines/SketchModeling/Network/output/sty_mad1/',
							"""Directory where to write testing logs.""")
tf.app.flags.DEFINE_string('check_dir', '/vol/research/zyres/3dv/baselines/SketchModeling/Network/output/sty_mad/',
							"""Directory where to write testing logs.""")
